<?php 
		...
		/*
			...
			$_SESSION["cart_item"] 
					"a4"=>("p_id"=>4,"p_code"=>4,"p_name"=>"Samsung galaxy",
							"p_price"=>12000000,"p_quantity"=>4,
							"p_image"=>"anh1.jpg"), 
					"a6"=>("p_id"=>6,"p_code"=>6,"p_name"=>"Samsung galaxy plus",
							"p_price"=>12000000,"p_quantity"=>4,
							"p_image"=>"anh1.jpg")		
						...
						<tr height=500 valign=top>
								...
								<td>
										<div>Shopping Cart
											...
											<a href=?action=empty>Emty Cart</a>
										<br>
											...
											?>	
												...
												<?php 
														...
														while ($r1=$result->fetch_assoc()){
															...
															echo "<a href='detail.php?p_id=".$r1["p_id"]."'><h2>".$r1["p_code"]."-".$r1["p_name"]."</h2>";
